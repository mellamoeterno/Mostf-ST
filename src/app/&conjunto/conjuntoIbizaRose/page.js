...
// name specific price specific name specific price specific name specific price specific name  
  const specificName = "Conjunto Bordado ibiza Rosé";
...
//CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART
    ...
    addToCart({
      id: `Conjunto Bordado ibiza Rosé -${selectedSize}`,//title title title title title title title title
      name: `Conjunto Bordado ibiza Rosé - Tamanho ${selectedSize}`,//title title title title title title
