...
const conjuntos = [
  {
    ...
    title: "Conjunto Urban Chic Nude", //RELACIONADOS RELACIONADOS RELACIONADOS
    price: 189,
  },
];

// name specific price specific name specific price specific name specific price specific name  
  const specificName = "Conjunto Urban Chic Verde Candy";
...
//CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART
    ...
    addToCart({
      id: `Conjunto Urban Chic Verde Candy -${selectedSize}`,//title title title title title title title title
      name: `Conjunto Urban Chic Verde Candy - Tamanho ${selectedSize}`,//title title title title title title
