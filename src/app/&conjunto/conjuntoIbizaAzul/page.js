...
const conjuntos = [
  {
    ...
    src: "https://res.cloudinary.com/dyiyheyzq/image/upload/v1761366312/leseV_2_qmdmdz.png",
    title: "vestido Lese Vermelho", //RELACIONADOS RELACIONADOS RELACIONADOS
    price: 199,
  },
];

// name specific price specific name specific price specific name specific price specific name  
  const specificName = "Conjunto Bordado ibiza Azul";
...
//image image image image image image image image image image image image image image image
  ...
  const images = [
    ...
    "https://res.cloudinary.com/dyiyheyzq/image/upload/v1761424969/ConjuntoBordadoAzul149P_2_lhpd18.png",
  ];
...
//CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART
    ...
    addToCart({
      id: `Conjunto Bordado ibiza Azul -${selectedSize}`,//title title title title title title title title
      name: `Conjunto Bordado ibiza Azul - Tamanho ${selectedSize}`,//title title title title title title
