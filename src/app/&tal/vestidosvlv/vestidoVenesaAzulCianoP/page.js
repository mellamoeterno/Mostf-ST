...
// name specific price specific name specific price specific name specific price specific name  
  const specificName = "Vestido Venesa Azul Ciano Claro P";
  const specificPrice = "100" // your title data
...
//image image image image image image image image image image image image image image image
  ...
  const images = [
    ...
    "https://res.cloudinary.com/dyiyheyzq/image/upload/v1761416446/vestidoVenesaP159_1_is1evk.png",
  ];
...
//CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART
    ...
    addToCart({
      id: `Vestido Venesa Ciano Claro -${selectedSize}`,//title title title title title title title title
      name: `Vestido Venesa Ciano Claro - Tamanho ${selectedSize}`,//title title title title title title
      price: 100, //price price price price price price price price price price price price
      size: selectedSize,
      quantity: 1,
      image: images[0],
    });
