...
// name specific price specific name specific price specific name specific price specific name  
  const specificName = "Vestido tubinho Bege P";
...
//image image image image image image image image image image image image image image image
  ...
  const images = [
    ...
    "https://res.cloudinary.com/dyiyheyzq/image/upload/v1761442450/VestidoTubihno129P_1_jmecbi.jpg",
  ];
...
//CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART
    ...
    addToCart({
      id: `Vestido tubinho Bege -${selectedSize}`,//title title title title title title title title
      name: `Vestido tubinho Bege - Tamanho ${selectedSize}`,//title title title title title title
