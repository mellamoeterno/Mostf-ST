...
// name specific price specific name specific price specific name specific price specific name  
  const specificName = "Vestido Tubinho Preto G";
...
//image image image image image image image image image image image image image image image
  ...
  const images = [
    ...
    "https://res.cloudinary.com/dyiyheyzq/image/upload/v1761443032/vestidoTubinhoPreto129G_2_x63y8l.jpg",
  ];
...
//CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART
    ...
    addToCart({
      id: `Vestido Tubinho Preto -${selectedSize}`,//title title title title title title title title
      name: `Vestido Tubinho Preto - Tamanho ${selectedSize}`,//title title title title title title
