...
// name specific price specific name specific price specific name specific price specific name  
  const specificName = "Vestido Tubinho Rosa P";
...
//image image image image image image image image image image image image image image image
  ...
  const images = [
    ...
    "https://res.cloudinary.com/dyiyheyzq/image/upload/v1761442748/vestidoTubinhoRos%C3%A9P129_2_aeze3y.png",
  ];
...
//CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART
    ...
    addToCart({
      id: `Vestido Tubinho Rosa -${selectedSize}`,//title title title title title title title title
      name: `Vestido Tubinho Rosa - Tamanho ${selectedSize}`,//title title title title title title
