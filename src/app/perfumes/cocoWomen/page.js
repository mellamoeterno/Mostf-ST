...
//CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART
    ...
    addToCart({
      id: `coco-${selectedSize}`,//title title title title title title title title
      name: `coco Volume ${selectedSize}`, //title title title title title title
