...
//CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART
    ...
    addToCart({
      id: `HCC women-${selectedSize}`,//title title title title title title title title
      name: `HCC women volume ${selectedSize}`, //title title title title title title
