...
// name specific price specific name specific price specific name specific price specific name  
  const specificName = "signSweet";
  const specificPrice = "45" // your title data
...
//CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART CART
    ...
    addToCart({
      id: `signSweet-${selectedSize}`,//title title title title title title title title
      name: `signSweet Volume ${selectedSize}`, //title title title title title title
      price: 45,//price price price price price price price price price price price price
      size: selectedSize,
      quantity: 1,
      image: images[0],
    });
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-between">
            <div>
              ...
              <p className="text-gray-700 mb-6"> R$ {specificPrice}</p>
               ...
               <div className="mb-6">
                <h2 className="text-[#133010] text-lg font-semibold mb-2">Volume</h2> 
